# Middleware developer documentation
...
```code
tim@deb10-test:/var/log/billy$ curl --request POST --url http://127.0.0.1:8888/api/AuthenticationToken/Get/ --data '{"Username":"admin", "Password": "billy.1"}'
