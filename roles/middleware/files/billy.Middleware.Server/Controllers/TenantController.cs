...
namespace billy.Middleware.Controllers
{
    ...
    public class TenantController : ControllerBase
    {
        ...
        {
            Tenant[] tenants = (await apiConnection.SendQueryAsync<Tenant[]>(billy.Api.Client.Queries.AuthQueries.getTenants));
        ...
        public async Task<int> Post([FromBody] TenantAddParameters tenant)
        {
            ...
            if (tenantAdded) 
            {
                ...
                try
                {
                    ...
                    ReturnId[]? returnIds = (await apiConnection.SendQueryAsync<NewReturning>(billy.Api.Client.Queries.AuthQueries.addTenant, Variables)).ReturnIds;
                    if (returnIds != null)
                    {
        ...
        public async Task<bool> Change([FromBody] TenantEditParameters parameters)
        {
            ...
            try
            {
                ...
                ReturnId returnId = await apiConnection.SendQueryAsync<ReturnId>(billy.Api.Client.Queries.AuthQueries.updateTenant, Variables);
        ...
        public async Task<bool> Delete([FromBody] TenantDeleteParameters tenant)
        {
            ...
            try
            {
                ...
                int delId = (await apiConnection.SendQueryAsync<ReturnId>(billy.Api.Client.Queries.AuthQueries.deleteTenant, Variables)).DeletedId;
                if (delId == tenant.Id)
                {
                    tenantDeleted = true;
