    ...
    public class RequestDbAccess
    {
        ...
        public async Task<List<RequestTicket>> FetchTickets(StateMatrix stateMatrix, int viewOpt = 0)
        {
            ...
            try
            {
                ...
                requests = await ApiConnection.SendQueryAsync<List<RequestTicket>>(billy.Api.Client.Queries.RequestQueries.getTickets, Variables);
        ...
        public async Task<RequestTicket> GetTicket(int id)
        {
            ...
            try
            {
                ...
                ticket = await ApiConnection.SendQueryAsync<RequestTicket>(billy.Api.Client.Queries.RequestQueries.getTicketById, Variables);
                ticket.UpdateCidrsInTaskElements();
            }
            catch (Exception exception)
            {
        ...
        public async Task<RequestTicket> AddTicketToDb(RequestTicket ticket)
        {
            try
            {
                ...
                ReturnId[]? returnIds = (await ApiConnection.SendQueryAsync<NewReturning>(billy.Api.Client.Queries.RequestQueries.newTicket, Variables)).ReturnIds;
                if (returnIds == null)
                {
        ...
        public async Task<RequestTicket> UpdateTicketInDb(RequestTicket ticket)
        {
            try
            {
                ...
                int udId = (await ApiConnection.SendQueryAsync<ReturnId>(billy.Api.Client.Queries.RequestQueries.updateTicket, Variables)).UpdatedId;
                if(udId != ticket.Id)
                {
        ...
        public async Task<int> AddReqTaskToDb(RequestReqTask reqtask)
        {
            ...
            try
            {
                ...
                ReturnId[]? returnIds = (await ApiConnection.SendQueryAsync<NewReturning>(billy.Api.Client.Queries.RequestQueries.newRequestTask, Variables)).ReturnIds;
                if (returnIds == null)
                {
        ...
        public async Task UpdateReqTaskInDb(RequestReqTask reqtask)
        {
            try
            {
                ...
                int udId = (await ApiConnection.SendQueryAsync<ReturnId>(billy.Api.Client.Queries.RequestQueries.updateRequestTask, Variables)).UpdatedId;
                if(udId != reqtask.Id)
                {
        ...
        public async Task DeleteReqTaskFromDb(RequestReqTask reqtask)
        {
            try
            {
                int delId = (await ApiConnection.SendQueryAsync<ReturnId>(billy.Api.Client.Queries.RequestQueries.deleteRequestTask, new { id = reqtask.Id })).DeletedId;
                if(delId != reqtask.Id)
                {
        ...
        public async Task<int> AddReqElementToDb(RequestReqElement element)
        {
            ...
            try
            {
                ...
                ReturnId[]? returnIds = (await ApiConnection.SendQueryAsync<NewReturning>(billy.Api.Client.Queries.RequestQueries.newRequestElement, Variables)).ReturnIds;
                if (returnIds == null)
                {
        ...
        public async Task UpdateReqElementInDb(RequestReqElement element)
        {
            try
            {
                ...
                int udId = (await ApiConnection.SendQueryAsync<ReturnId>(billy.Api.Client.Queries.RequestQueries.updateRequestElement, Variables)).UpdatedId;
                if(udId != element.Id)
                {
        ...
        public async Task DeleteReqElementFromDb(long elementId)
        {
            try
            {
                long delId = (await ApiConnection.SendQueryAsync<ReturnId>(billy.Api.Client.Queries.RequestQueries.deleteRequestElement, new { id = elementId })).DeletedId;
                if(delId != elementId)
                {
        ...
        public async Task<int> AddApprovalToDb(RequestApproval approval)
        {
            ...
            try
            {
                ...
                ReturnId[]? returnIds = (await ApiConnection.SendQueryAsync<NewReturning>(billy.Api.Client.Queries.RequestQueries.newApproval, Variables)).ReturnIds;
                if (returnIds == null)
                {
        ...
        public async Task UpdateApprovalInDb(RequestApproval approval)
        {
            try
            {
                ...
                int udId = (await ApiConnection.SendQueryAsync<ReturnId>(billy.Api.Client.Queries.RequestQueries.updateApproval, Variables)).UpdatedId;
                if(udId != approval.Id)
                {
        ...
        public async Task<int> AddImplTaskToDb(RequestImplTask impltask)
        {
            ...
            try
            {
                ...
                ReturnId[]? returnIds = (await ApiConnection.SendQueryAsync<NewReturning>(billy.Api.Client.Queries.RequestQueries.newImplementationTask, Variables)).ReturnIds;
                if (returnIds == null)
                {
                    DisplayMessageInUi(null, UserConfig.GetText("add_task"), UserConfig.GetText("E8003"), true);
                }
        ...
        public async Task UpdateImplTaskInDb(RequestImplTask impltask)
        {
            try
            {
                ...
                int udId = (await ApiConnection.SendQueryAsync<ReturnId>(billy.Api.Client.Queries.RequestQueries.updateImplementationTask, Variables)).UpdatedId;
                if(udId != impltask.Id)
                {
                    DisplayMessageInUi(null, UserConfig.GetText("save_task"), UserConfig.GetText("E8004"), true);
                }
        ...
        public async Task DeleteImplTaskFromDb(RequestImplTask impltask)
        {
            try
            {
                int delId = (await ApiConnection.SendQueryAsync<ReturnId>(billy.Api.Client.Queries.RequestQueries.deleteImplementationTask, new { id = impltask.Id })).DeletedId;
        ...
        public async Task<int> AddImplElementToDb(RequestImplElement element)
        {
            ...
            try
            {
                ...
                ReturnId[]? returnIds = (await ApiConnection.SendQueryAsync<NewReturning>(billy.Api.Client.Queries.RequestQueries.newImplementationElement, Variables)).ReturnIds;
                if (returnIds == null)
                {
                    DisplayMessageInUi(null, UserConfig.GetText("add_element"), UserConfig.GetText("E8006"), true);
                }
        ...
        public async Task UpdateImplElementInDb(RequestImplElement element)
        {
            try
            {
                ...
                int udId = (await ApiConnection.SendQueryAsync<ReturnId>(billy.Api.Client.Queries.RequestQueries.updateImplementationElement, Variables)).UpdatedId;
                if(udId != element.Id)
                {
                    DisplayMessageInUi(null, UserConfig.GetText("save_element"), UserConfig.GetText("E8007"), true);
                }
        ...
        public async Task DeleteImplElementFromDb(long elementId)
        {
            try
            {
                long delId = (await ApiConnection.SendQueryAsync<ReturnId>(billy.Api.Client.Queries.RequestQueries.deleteImplementationElement, new { id = elementId })).DeletedId;
                if(delId != elementId)
                {
                    DisplayMessageInUi(null, UserConfig.GetText("delete_element"), UserConfig.GetText("E8008"), true);
                }
        ...
        public async Task<int> AddCommentToDb(RequestComment comment)
        {
            ...
            try
            {
                ...
                ReturnId[]? returnIds = (await ApiConnection.SendQueryAsync<NewReturning>(billy.Api.Client.Queries.RequestQueries.newComment, Variables)).ReturnIds;
                if (returnIds == null)
                {
        ...
        public async Task AssignCommentToTicketInDb(long ticketId, long commentId)
        {
            try
            {
                ...
                ReturnId[]? returnIds = (await ApiConnection.SendQueryAsync<NewReturning>(billy.Api.Client.Queries.RequestQueries.addCommentToTicket, Variables)).ReturnIds;
                if (returnIds == null)
                {
                    DisplayMessageInUi(null, UserConfig.GetText("add_comment"), UserConfig.GetText("E8012"), true);
                }
        ...
        public async Task AssignCommentToReqTaskInDb(long taskId, long commentId)
        {
            try
            {
                ...
                ReturnId[]? returnIds = (await ApiConnection.SendQueryAsync<NewReturning>(billy.Api.Client.Queries.RequestQueries.addCommentToReqTask, Variables)).ReturnIds;
                if (returnIds == null)
                {
                    DisplayMessageInUi(null, UserConfig.GetText("add_comment"), UserConfig.GetText("E8012"), true);
                }
        ...
        public async Task AssignCommentToImplTaskInDb(long taskId, long commentId)
        {
            try
            {
                ...
                ReturnId[]? returnIds = (await ApiConnection.SendQueryAsync<NewReturning>(billy.Api.Client.Queries.RequestQueries.addCommentToImplTask, Variables)).ReturnIds;
                if (returnIds == null)
                {
                    DisplayMessageInUi(null, UserConfig.GetText("add_comment"), UserConfig.GetText("E8012"), true);
                }
        ...
        public async Task AssignCommentToApprovalInDb(long approvalId, long commentId)
        {
            try
            {
                ...
                ReturnId[]? returnIds = (await ApiConnection.SendQueryAsync<NewReturning>(billy.Api.Client.Queries.RequestQueries.addCommentToApproval, Variables)).ReturnIds;
                if (returnIds == null)
                {
                    DisplayMessageInUi(null, UserConfig.GetText("add_comment"), UserConfig.GetText("E8012"), true);
                }
        ...
        public async Task UpdateTicketStateInDb(RequestTicket ticket)
        {
            try
            {
                ...
                int udId = (await ApiConnection.SendQueryAsync<ReturnId>(billy.Api.Client.Queries.RequestQueries.updateTicketState, Variables)).UpdatedId;
                if(udId != ticket.Id)
                {
                    DisplayMessageInUi(null, UserConfig.GetText("save_request"), UserConfig.GetText("E8002"), true);
                }
        ...
        public async Task UpdateReqTaskStateInDb(RequestReqTask reqtask)
        {
            try
            {
                ...
                int udId = (await ApiConnection.SendQueryAsync<ReturnId>(billy.Api.Client.Queries.RequestQueries.updateRequestTaskState, Variables)).UpdatedId;
                if(udId != reqtask.Id)
                {
                    DisplayMessageInUi(null, UserConfig.GetText("save_task"), UserConfig.GetText("E8004"), true);
                }
        ...
        public async Task UpdateImplTaskStateInDb(RequestImplTask impltask)
        {
            try
            {
                ...
                int udId = (await ApiConnection.SendQueryAsync<ReturnId>(billy.Api.Client.Queries.RequestQueries.updateImplementationTaskState, Variables)).UpdatedId;
                if(udId != impltask.Id)
                {
                    DisplayMessageInUi(null, UserConfig.GetText("save_task"), UserConfig.GetText("E8004"), true);
                }
        ...
        public async Task<bool> FindRuleUid(int? deviceId, string? ruleUid)
        {
            ...
            try
            {
                ...
                ruleFound = (await ApiConnection.SendQueryAsync<List<Rule>>(billy.Api.Client.Queries.RuleQueries.getRuleByUid, Variables)).Count > 0;
            }
            catch (Exception exception)
            {
