...
namespace billy.DeviceAutoDiscovery
{
    public class AutoDiscoveryBase
    {
        ...
        public async Task<List<Management>> GetDeltas(List<Management> discoveredManagements)
        {
            ...
            try
            {
                existingManagements = await apiConnection.SendQueryAsync<List<Management>>(billy.Api.Client.Queries.DeviceQueries.getManagementsDetails);
