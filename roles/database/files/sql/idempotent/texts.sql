...
INSERT INTO txt VALUES ('api_fwo',              'German', 	'billy API');
INSERT INTO txt VALUES ('api_fwo',              'English', 	'billy API');
...
INSERT INTO txt VALUES ('H6001', 'German',  'Firewall Orchestrator verf&uuml;gt &uuml;ber zwei APIs:
    <ul>
        <li>Die Haupt- (oder billy) API, die den Zugriff auf die Firewall-Nutzdaten erlaubt.</li>
    ...
    Die billy API ist eine <a href="/help/API/graphql">GraphQl</a> API, welche auf <a href="/help/API/hasura">Hasura</a> basiert. 
...
INSERT INTO txt VALUES ('H6001', 'English', 'Firewall Orchestrator features two APIs:
    <ul>
        <li>The main (or billy) API which allows access to the firewall configuration data</li>
        <li>The User Management API which can be used to handle Firewall Orchestrator users</li>
    </ul>

    The billy API is a <a href="/help/API/graphql">GraphQl</a> API which is based on <a href="/help/API/hasura">Hasura</a>. 
